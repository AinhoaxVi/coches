...
test("index carga todos los recursos versionados", () => {
  ...
  for (const asset of ["styles.css?v=8", "catalog.js?v=8", "diagnosis-data.js?v=8", "app.js?v=8"]) {
...
test("el service worker precachea los recursos críticos y permite actualizar", () => {
  const sw = read("sw.js");
  for (const asset of ["styles.css?v=8", "catalog.js?v=8", "diagnosis-data.js?v=8", "app.js?v=8"]) assert.ok(sw.includes(asset));
